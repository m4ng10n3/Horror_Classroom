...
public class TeacherStateMachine : MonoBehaviour
{
    ...
    // Evento per notificare chi � interessato del cambio stato
    ...
    void Start()
    {
        // Notifica lo stato iniziale (cos� i listener possono settare subito luci/colori)
    ...
    public void RegisterWrongAnswer()
    {
        ...
        switch (currentState)
        {
            ...
            case TeacherState.Angry:
                // FASE 6: qui triggereremo "ultima possibilit�".
